...
export function ClientPage() {
  ...
  const [table, setTable] = useState({
    ...
    columns: [
      ...
      },
      {
        ...
        width: "100px",
        hide: false,
        renderCell: (params: any) => <p>{params.status?.name}</p>,
      },
      {
        field: "",
        headerName: "",
  ...
  const statusesList = ClientsService.GetClientStatuses();
        ...
        <div className="flex items-center gap-[20px]">
          <FormControl size={"small"}>
            ...
            >
              ...
              {!trafficSourceList.loading &&
                !trafficSourceList.error &&
                trafficSourceList.result?.data.map(
          ...
          <FormControl size={"small"}>
            ...
            >
              ...
              {!managerList.loading &&
                !managerList.error &&
                managerList.result?.data.results.map(
          ...
          <FormControl size={"small"}>
            ...
            >
              ...
              {!statusesList.loading &&
                !statusesList.error &&
                statusesList.result?.data.map((status: any, index: number) => (
                  <MenuItem key={index} value={status.id}>
                    {status.name}
                  </MenuItem>
                ))}
              ...
              {modal.action !== "delete" ? (
                <div className="grid grid-cols-2 gap-[24px] gap-x-[60px]">
                  ...
                  <DatePicker
                    ...
                    value={
                      modal.values.birthday
                        ? dayjs(modal.values.birthday)
                        : null
                    }
                    onChange={(date) => {
                      setModal({
                  ...
                  <FormControl>
                    ...
                    >
                      ...
                      {!trafficSourceList.loading &&
                        !trafficSourceList.error &&
                        trafficSourceList.result?.data.map(
                          (trafficSource: any, index: number) => (
                            <MenuItem key={index} value={trafficSource.id}>
                              {trafficSource.name}
                            </MenuItem>
                          )
                        )}
