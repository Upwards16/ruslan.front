                ...
                <div className="grid grid-cols-2 gap-[30px] gap-x-[60px]">
                  ...
                  <FormControl>
                    ...
                    >
                      ...
                      {!getPaymentTypesList.loading &&
                        !getPaymentTypesList.error &&
                        getPaymentTypesList.result?.data.map(
              ...
              <div className="flex justify-center w-full mt-[50px]">
                <button
                  ...
                  className={`outline-none text-[12px] py-[14px] px-[14px] bg-[#4E54E1] text-white rounded-[100px] w-[259px] ${
                    isLoading ? "cursor-not-allowed z-50 opacity-50" : ""
                  }`}
                  disabled={isLoading}
                >
                  {isLoading ? (
                    <div className="flex justify-center">
                      <div className="w-[19px] h-[19px] border-2 rounded-full border-t-transparent border-white animate-spin"></div>
                    </div>
                  ) : (
                    <div>
                      {modal.action === "delete" && "Удалить"}
