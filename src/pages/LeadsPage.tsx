      ...
      },
      {
        ...
        renderCell: (params: any) =>
          params.reminder_date !== null
            ? moment(params.reminder_date).format("DD.MM.YYYY hh:mm")
            : "",
      },
      {
        field: "status",
                ...
                <div>
                  <div className="grid grid-cols-2 gap-[30px] gap-x-[60px]">
                    ...
                    <DateTimePicker
                      ...
                      value={
                        modal.values.reminder_date
                          ? dayjs(modal.values.reminder_date)
                          : null
                      }
                      onChange={(date) => {
                        setModal({
