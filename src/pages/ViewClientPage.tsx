...
export default function ViewClientPage() {
  ...
  const client = ClientsService.GetClientByAsyncHook(
        ...
        <div className="grid grid-cols-1 gap-[24px]">
          <div className="p-5 rounded-[10px] bg-white shadow-block">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-[10px] font-medium text-[#8C8C8C]">Клиент</p>
            ...
            <div className="mt-[24px] flex justify-between">
              ...
              <div>
                ...
                <h2 className="text-[16px] text-[#505050] font-medium">
                  <h2 className="text-[16px] text-[#505050] font-medium">
                    {client.result?.data.status.name}
                  </h2>
                </h2>
              </div>
            </div>
          ...
          <div className="col-start-1 col-end-3 w-full h-full p-5 rounded-[10px] bg-white shadow-block flex flex-col justify-start items-start">
            <h2 className="text-[16px] font-[600] text-[#282828] mb-[30px]">
              Проекты
            </h2>
            ...
            <DetailedViewTable
              ...
              footer={
                <div className="w-full bg-white flex justify-between items-center p-2.5 pt-[40px] pl-[30px] pb-[20px]">
