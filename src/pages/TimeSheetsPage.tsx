...
export default function TimeSheetsPage() {
  ...
  if (userPosition === "admin") {
    employeeList = EmployeesService.GetEmployeeList({});
  }
    ...
    <>
      ...
      <div className=" flex items-center justify-between mt-[42px]">
        <div className="flex items-center gap-[20px]">
          ...
          {(userPosition === "admin" || userPosition === "project-manager") && (
            <FormControl size={"small"}>
              ...
              >
                ...
                {employeeList &&
                  !employeeList.loading &&
                  !employeeList.error &&
                  employeeList.result?.data.results.map(
                ...
                <div>
                  <div className="grid grid-cols-2 gap-[30px] gap-x-[60px]">
                    ...
                    <DatePicker
                      ...
                      value={
                        modal.values.date ? dayjs(modal.values.date) : null
                      }
                      onChange={(date) => {
                        setModal({
                          ...modal,
                      ...
                      onChange={(event: any) => {
                        setModal({
                          ...
                          values: {
                            ...modal.values,
                            time:
                              CheckForPositiveNumbers(event.target.value) > 24
                                ? 24
                                : CheckForPositiveNumbers(event.target.value),
                          },
                        });
                      }}
                      InputProps={{
